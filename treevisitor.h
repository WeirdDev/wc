...
#define visitor_method(name)		void visit##name (struct treevisitor_t* visitor, pmember object)
typedef void* (*visitor_method_ptr)(struct treevisitor_t* visitor, pmember object);
#define accept_method(name)			void name##_accept(struct treevisitor_t* visitor, pmember object)
